...
exports.postVerifyCards = async (req, res, next) => {
    ...
    const endResult = await verifySalesCardList(buy_token_type, buy_token_address, percent, quality, cardNameList).then((result) => result).catch(error => console.log('error', error));
